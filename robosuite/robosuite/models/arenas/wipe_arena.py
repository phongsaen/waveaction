...
class WipeArena(TableArena):
    ...
    def __init__(
        ...
        # sample table friction
        table_friction = np.array(table_friction) + np.maximum(np.zeros(3), np.random.normal(0, table_friction_std/table_friction[0]*np.array(table_friction)))
