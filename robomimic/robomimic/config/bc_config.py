...
class BCConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        self.algo.transformer.context_length = 60                   # length of (s, a) seqeunces to feed to transformer - should usually match train.frame_stack
        self.algo.transformer.embed_dim = 768                       # dimension for embeddings used by transformer
        self.algo.transformer.num_layers = 8                        # number of transformer blocks to stack
        self.algo.transformer.num_heads = 12                        # number of attention heads for each transformer block (should divide embed_dim evenly)
    ...
    def observation_config(self):
        super(BCConfig, self).observation_config()
        self.observation.modalities.obs.low_dim += ["robot0_eef_v_s"]
    """
