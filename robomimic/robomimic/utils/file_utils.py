...
def model_from_checkpoint(device=None, ckpt_path=None, ckpt_dict=None, verbose=False):
    """
    This function restores an ONWARD TRAINING policy from a checkpoint file or
    loaded model dictionary.
    ...
    model.set_train()
    # obs_normalization will be augmented in train_from_checkpoint.py from the dataset
