...
def get_data_loader(dataset_path):
    ...
    dataset = SequenceDataset(
        ...
        obs_keys=(                      # observations we want to appear in batches
            ...
            "robot0_gripper_qpos", 
            "object",
            "robot0_eef_reaction_v",
            "robot0_eef_reaction_w",
            "robot0_eef_action_v",
            "robot0_eef_action_w",
        ),
...
def get_example_model(dataset_path, device):
    ...
    #config.observation.modalities.obs.low_dim += ["robot0_eef_action_v", "robot0_eef_action_w"]
    #config.observation.modalities.obs.low_dim = ["robot0_eef_pos", "robot0_eef_quat", "robot0_eef_vel_lin", "robot0_eef_vel_ang", "robot0_eef_force", "robot0_eef_torque", "robot0_gripper_qpos", "object", "robot0_eef_action_v", "robot0_eef_action_w"]
    config.observation.modalities.obs.low_dim = ["robot0_gripper_qpos", "object", "robot0_eef_reaction_v", "robot0_eef_reaction_w", "robot0_eef_action_v", "robot0_eef_action_w"]
    #config.observation.modalities.obs.low_dim = ["robot0_eef_reaction_v", "robot0_eef_reaction_w", "robot0_eef_action_v", "robot0_eef_action_w"]
    config.observation.modalities.obs.rgb = ["agentview_image"]
    #config.algo.actor_layer_dims = [128, 512, 1024, 2048, 2048, 2048, 1024, 512, 128]
...
def run_train_loop(model, data_loader):
    ...
    """
    num_epochs = 50
    gradient_steps_per_epoch = len(data_loader)
...
if __name__ == "__main__":
    ...
    dataset_path = "/home/phongsaen/robosuite/robosuite/models/assets/demonstrations/1730776722_9523654/image.hdf5"
